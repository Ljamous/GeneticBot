            ...
            <div class="card card-info mx-auto" style="width: 70%; border-radius: 10px;">
                ...
                <div class="card-body">
                    ...
                    <div id="uploadSection" style="display: none;">
                        ...
                        <?php if (!empty($imgData) && str_starts_with($filetype, 'image/')): ?>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Image Preview</label>
                            <div class="col-sm-8">
                                <img src="data:<?= htmlspecialchars($filetype) ?>;base64,<?= base64_encode($imgData) ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const hasExistingFile = <?= json_encode(!empty($filename)) ?>;
